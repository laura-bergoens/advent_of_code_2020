const fs = require('fs');
const { jobFirstPolicy, jobSecondPolicy } = require('./job');
...
Each policy actually describes two positions in the password, where 1 means the first character, 2 means the second character,
 and so on. (Be careful; Toboggan Corporate Policies have no concept of "index zero"!) Exactly one of these positions
