...
the locals just call them stars. None of the currency exchanges seem to have heard of them, but somehow, you'll need to find
...
async function main() {
  try {
    ...
    const solution1 = jobX(rawInput, 2, GOAL);
    console.log(`job1 : ${solution1}`);
    const solution2 = jobX(rawInput, 3, GOAL);
